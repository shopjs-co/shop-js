...
var _CartLineItem = _interopRequireDefault(require("./CartLineItem"));
...
var CartLineItems = function CartLineItems(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_material.List, {
    ...
    disablePadding: true
  }, checkout !== null && checkout !== void 0 && checkout.lineItems ? checkout.lineItems.edges.map(function (_ref2, i) {
    var lineItem = _ref2.node;
    return /*#__PURE__*/_react["default"].createElement(_CartLineItem["default"], {
      lineItem: lineItem,
      key: lineItem.id
    });
